...
void MainWindow::on_plus_button_clicked()
{
	...
	int data[23] = {0,690,0,0,0,0,0,0,0,0,690,1031,341,1031,341,690,690,0,1380,1201,170,690,690};// 4095 값 미니멈
...
void MainWindow::on_minus_button_clicked()
{
	...
	int data[23] = {0,-690,0,0,0,0,0,0,0,0,-690,-341,-1031,-341,-1031,-690,-690,-1380,0,-170,-1201,-690,-690};// 4095 값 미니멈
...
void MainWindow::on_read_data_one_clicked() {
	...
	//ROS_INFO("%d  ////   %d",offset_joint_int16_, read_joint_value_msg_.response.angle[offset_joint_int16_]);
