...
enum SelectionRectMode { srmNone    ///< The selection rect is disabled, and all mouse events are forwarded to the underlying objects, e.g. for axis range dragging
                         ...
                         ,srmCustom ///< When dragging the mouse, a selection rect becomes active. It is the programmer's responsibility to connect according Q_SLOTS to the selection rect's Q_SIGNALS (e.g. \ref QCPSelectionRect::accepted) in order to process the user interaction.
                       };
