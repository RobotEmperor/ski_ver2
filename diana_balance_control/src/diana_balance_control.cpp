...
{
  foot_roll_adjustment_by_gyro_roll_   = -1.0*foot_roll_gyro_ctrl_.getFeedBack(current_gyro_roll_rad_per_sec_);
  foot_pitch_adjustment_by_gyro_pitch_ = -1.0*foot_pitch_gyro_ctrl_.getFeedBack(current_gyro_pitch_rad_per_sec_);
}
